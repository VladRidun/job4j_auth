...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    private SimplePersonService personDetailsService;
    private BCryptPasswordEncoder bCryptPasswordEncoder;

    public WebSecurity(SimplePersonService personDetailsService, BCryptPasswordEncoder bCryptPasswordEncoder) {
